...
cp $TMPDIR/$CLIENT_PKGDIR/DeleteWorkflow.java $DESTDIR/$CLIENT_PKGDIR
cp $TMPDIR/$CLIENT_PKGDIR/DeleteWorkflowResponse.java $DESTDIR/$CLIENT_PKGDIR
...
cp $TMPDIR/$CLIENT_PKGDIR/RunWorkflow.java $DESTDIR/$CLIENT_PKGDIR
cp $TMPDIR/$CLIENT_PKGDIR/RunWorkflowResponse.java $DESTDIR/$CLIENT_PKGDIR
rm -r $TMPDIR
