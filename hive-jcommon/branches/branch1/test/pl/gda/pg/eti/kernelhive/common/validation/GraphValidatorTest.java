...
public class GraphValidatorTest {
	...
	public void setUp() throws Exception {
		...
		// kernelFiles.add(new KernelFile(File.createTempFile("test", "test"),
		// "k1", props));
		// engineGraphNodes.add(new EngineGraphNodeDecorator(node1,
		// kernelStrings));
		// engineGraphNodes.add(new EngineGraphNodeDecorator(node2,
		// kernelStrings));
		// engineGraphNodes.add(new EngineGraphNodeDecorator(node3,
		// kernelStrings));
		// engineGraphNodes.add(new EngineGraphNodeDecorator(node4,
		// kernelStrings));
		//
	...
	public final void testValidateGraphForGUI() {
		...
		// GraphValidator.validateGraphForGUI(guiGraphNodes);
		// for(ValidationResult vr : result){
		// assertEquals(vr.getMesssage(), ValidationResultType.VALID,
		// vr.getType());
		// }
	}
	...
	public final void testValidateGraphForEngine() {
		// List<ValidationResult> result =
		// GraphValidator.validateGraphForEngine(engineGraphNodes);
		// for(ValidationResult vr : result){
		// assertEquals(vr.getMesssage(), ValidationResultType.VALID,
		// vr.getType());
		// }
