...
public class Job extends HasID {
	...
	public enum JobState {
		PENDING, READY, SCHEDULED, PROCESSING, FINISHED
	}

	/*
	 * public List<String> dataHosts = new ArrayList<String>(); public
	 * List<Integer> dataPorts = new ArrayList<Integer>(); public List<Integer>
	...
	/*
	 * public void setDataAddress(String status) { System.out.println(status);
	 * String[] dataAddress = status.split(" "); this.dataHost = dataAddress[0];
	 * this.dataPort = dataAddress[1]; this.dataID = dataAddress[2]; }
	 */
