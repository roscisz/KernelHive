...
public class ClientBean implements IClientBeanRemote {
	...
	private static String serializedGraphConf = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?><kh:project><kh:node hash=\"-1341250129\" id=\"e038c1db-c4d9-4a61-b188-495c81200125\" name=\"name1\" parent-id=\"\" type=\"DataPartitioner\"><kh:first-children-nodes/><kh:send-to><kh:following-node id=\"8b584317-997f-4ef6-998a-86a1f21ff60b\"/><kh:following-node id=\"cbb7d846-ec04-4b8a-a9f6-a85bac9c694f\"/></kh:send-to><kh:properties/><kh:kernels><kh:kernel id=\"eff1aa1a-686b-49bb-8ba5-47f607f27a45\" src=\"kernel src\"><kh:property key=\"globalSizes\" value=\"1 0 0\"/><kh:property key=\"offsets\" value=\"0 0 0\"/><kh:property key=\"numberOfDimensions\" value=\"1\"/><kh:property key=\"localSizes\" value=\"1 1 1\"/><kh:property key=\"globalSizes\" value=\"1 1 1\"/><kh:property key=\"offsets\" value=\"0 0 0\"/><kh:property key=\"numberOfDimensions\" value=\"1\"/><kh:property key=\"localSizes\" value=\"1 1 1\"/><kh:property key=\"globalSizes\" value=\"1 1 1\"/><kh:property key=\"offsets\" value=\"0 0 0\"/><kh:property key=\"numberOfDimensions\" value=\"1\"/><kh:property key=\"localSizes\" value=\"1 1 1\"/><kh:property key=\"globalSizes\" value=\"1 1 1\"/><kh:property key=\"offsets\" value=\"0 0 0\"/><kh:property key=\"numberOfDimensions\" value=\"1\"/><kh:property key=\"localSizes\" value=\"1 1 1\"/></kh:kernel></kh:kernels></kh:node></kh:project>"; 
	...
	public Integer submitWorkflow(String serializedGraphConf) {
		...
		try {
			if(serializedGraphConf == null) serializedGraphConf = ClientBean.serializedGraphConf;
			List<EngineGraphNodeDecorator> nodes = egc.loadGraphForEngine(new StringReader(serializedGraphConf));
			// FIXME:
			return HiveEngine.getInstance().runWorkflow(nodes, "Project name"/*egc.getProjectName()*/, egc.getInputDataURL());			
