...
int main(int argc, char** argv) {
	...
	WorkerProxy::create("DataProcessor", "bin 666 localhost 31338 localhost 31338 GeForce9400MG 1 0 128 16 4 localhost 31341 456 2 localhost 31342 123 localhost 31340 111 localhost 31343");
