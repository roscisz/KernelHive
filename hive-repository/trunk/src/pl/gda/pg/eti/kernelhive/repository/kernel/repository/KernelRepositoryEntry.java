 ...
 *
 */
public class KernelRepositoryEntry implements IKernelRepositoryEntry, Serializable {

	private static final long serialVersionUID = -4658587858383597251L;
	private final IGraphNodeType type;
	private final String description;
	private final List<IKernelPathEntry> kernelsPaths;
	
	
	public KernelRepositoryEntry(IGraphNodeType type, String description, List<IKernelPathEntry> kernelsPaths){
		this.type = type;
	 ...
	 */
	public IGraphNodeType getGraphNodeType(){
		return type;
	}
